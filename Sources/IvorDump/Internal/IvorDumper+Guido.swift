...
extension IvorDumper {
    ...
    private static let pitchAccidentals: [GMNPitch.Accidental: String] = [.doubleFlat: "𝄫",
                                                                          .doubleSharp: "𝄪",
                                                                          .flat: "♭",
                                                                          .impliedSharp: "",
                                                                          .natural: "♮",
    ...
    private static let pitchNames: [GMNPitch.Name: String] = [.a: "A",
                                                              .ais: "Ais",
                                                              .b: "B",
                                                              .c: "C",
                                                              .cis: "Cis",
    ...
    private func _format(_ duration: GMNDuration) -> String {
        ...
        if let denom = duration.denominator,
           let numer = duration.numerator {
            ...
            if let dots = duration.dots, dots > 0 {
                result += spacer()
    ...
    private func _format(_ pitch: GMNPitch) -> String {
        guard let name = Self.pitchNames[pitch.name],
              let accidental = Self.pitchAccidentals[pitch.accidental]
        else { return "\(pitch)" }

        return name + accidental + pitch.octave.description
    }
